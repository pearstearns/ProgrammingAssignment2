...
##You put in a matrix (I use rnorm as well, they need to be square) and $set it puts that in to the (x) variable within the function
## $get reads x
...
## The main function is to return a matrix that is the inverse of 'x' using the previous makeCacheMatrix 
